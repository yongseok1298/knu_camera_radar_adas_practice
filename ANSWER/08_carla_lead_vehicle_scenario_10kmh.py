...
## TODO 3
LEAD_VEHICLE_BLUEPRINT = "vehicle.lincoln.mkz_2020"
...
def main() -> int:
    ...
    if waypoint is None:
        print("[FAIL] 가까운 Driving waypoint를 찾을 수 없습니다.")
        return 1

    lead_transform = waypoint.transform
    ...
    print()
    print(
        "[PASS] knu_lead spawned and driving at 10 km/h."
    )

    print(
        "Lead Vehicle은 10 km/h로 주행합니다. 종료하려면 Ctrl+C."
    )
